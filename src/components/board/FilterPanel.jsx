...
export default function FilterPanel({ filters, onChange, onClose, board }) {
  ...
  return (
    ...
    >
      <Card className="w-80 shadow-lg border-[#EDEDED]">
        <CardHeader className="flex flex-row items-center justify-between pb-3">
          <CardTitle className="text-lg font-bold text-[#1E1F21]">Filter Items</CardTitle>
        ...
        <CardContent className="space-y-6">
          {/* Status Filter */}
          <div>
            <h4 className="font-medium text-[#1E1F21] mb-3">Status</h4>
          ...
          {/* Priority Filter */}
          <div>
            <h4 className="font-medium text-[#1E1F21] mb-3">Priority</h4>
            <div className="space-y-2">
