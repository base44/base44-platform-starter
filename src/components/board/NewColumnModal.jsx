...
export default function NewColumnModal({ isOpen, onClose, onSubmit }) {
  ...
  const [dropdownOptions, setDropdownOptions] = useState([
    { value: "option1", label: "Option 1", color: "#5DA283" },
    { value: "option2", label: "Option 2", color: "#0E2E56" },
  ]);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-[#1E1F21]">Add New Column</DialogTitle>
        </DialogHeader>

        <form onSubmit={handleSubmit} className="space-y-6 pt-4">
          <div className="space-y-2">
            <Label htmlFor="column-title" className="text-[#1E1F21] font-medium">
              Column Title *
            </Label>
            <Input
              id="column-title"
          ...
          <div className="space-y-2">
            <Label htmlFor="column-type" className="text-[#1E1F21] font-medium">
              Column Type
            </Label>
            <Select
            ...
            >
              <SelectTrigger id="column-type" className="rounded-lg border-[#EDEDED] h-10">
          ...
          {columnData.type === "dropdown" && (
            <div className="space-y-3">
              <Label className="text-[#1E1F21] font-medium">Dropdown Options</Label>
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1 h-9 rounded-lg border-[#EDEDED]"
                  onKeyDown={(e) => {
                    if (e.key === "Enter") {
                      e.preventDefault();
                      handleAddOption();
                ...
                <Button
                  ...
                  variant="outline"
                  size="icon"
                  className="h-9 w-9 rounded-lg border-[#EDEDED]"
